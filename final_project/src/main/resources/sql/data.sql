insert into shops
values
       (1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'address1', '18:00', 'shop1', '10:00');
insert into shops
values (2, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'address2', '18:00', 'shop2', '10:00');
insert into shops
values (3, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'address3', '18:00', 'shop3', '10:00');
insert into shops
values (4, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'address4', '18:00', 'shop4', '10:00');

insert into brands
values (1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'CN', 'Gan');
insert into brands
values (2, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'CN', 'MoYo');
insert into brands
values (3, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'CN', 'QiYi');

insert into cubes
values (1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 1, 'THREE',
...
Gan 12 M Maglev 3x3x3 стал самым дорогим кубиком 3х3 без электронной начинки. Но его цена обусловлена применением инновационных решений, которые ранее не встречались в головоломках Ган или любых других кубах.',
        'https://m.media-amazon.com/images/I/51sq3XiMRdL._AC_SX425_.jpg',
         'Gan 12 M Maglev 3x3x3',500, true, 1);
insert into cubes
values (2, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 10, 'THREE',
        ...
        'https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcSs1mXqpspeWwKmFNkci6UhvJlYsTK0CEM7JfFIuUFPq8LoSsfRDROMIub9SA5VB1Wecd9VSmkNNw&usqp=CAc',
         'MoYu WeiLong WR MagLev 3х3 stickerless',1199, true, 2);
insert into cubes
values (3, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 10, 'THREE',
        ...
        'https://content1.rozetka.com.ua/goods/images/big/201229521.jpg',
         'GAN 11 M Pro Duo',1577, true, 1);
insert into cubes
values (4, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 10, 'TWO',
        ...
        'https://kubik.in.ua/upload/resize_cache/webp/upload/iblock/d65/acaf9b91-86a8-11e8-8500-3a6561333536_50640054-c18f-11e8-a7d7-3a6561333536.webp',
         'QiYi WuXia 2x2 stickerless',1199, true, 3);
